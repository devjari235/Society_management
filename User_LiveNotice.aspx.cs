...
{
    public partial class User_LiveNotice : System.Web.UI.Page
    {
        ...
        private void BindNotices()
        {
            ...
            using (SqlConnection conn = new SqlConnection(connStr))
            {
                ...
                string selectQuery = "SELECT n.Notice_id, n.Title, n.Description, n.Expiry_date, n.File_path, n.Importance, n.Status,  n.Posted_date,u.User_name FROM tblNotices n INNER JOIN tblUser u ON n.User_id = u.User_id WHERE u.User_id=@id  AND (n.Expiry_date IS NULL OR n.Expiry_date >= GETDATE())  ORDER BY  n.Posted_date DESC";
