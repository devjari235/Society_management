        ...
        <asp:Panel ID="pnlEmpty" runat="server" Visible="false">
            <div class="empty-state-container shadow-sm border rounded bg-white">
                <div class="empty-state-icon text-center">
                    <i class="bi bi-gear-fill floating-icon" style="color: #cbd5e1;"></i>
                </div>
                <h4 style="color: #495057; font-weight: 700; margin-bottom: 8px;">No Progressing Complaints</h4>
                <p style="color: #adb5bd; font-size: 0.95rem; max-width: 380px; margin-bottom: 24px; margin-left: auto; margin-right: auto;">
                    There are no complaints currently marked as 'In Progress'. Everything is either settled or awaiting assignment.
                </p>
                        ...
                        <asp:GridView ID="gvDisplay" runat="server" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Status">
                                    <ItemTemplate>
                                        <span class="status-badge px-3 py-1 text-white" style="background:#2196f3; border-radius:50px; font-size:0.8rem;">
                                            <%# Eval("Status") %>
                                        </span>
                                    </ItemTemplate>
                                </asp:TemplateField>
