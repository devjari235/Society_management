<%@ Page Title="" Language="C#" MasterPageFile="~/Adashboard.Master" AutoEventWireup="true" CodeBehind="EventDetails.aspx.cs" Inherits="Society_management.EventDetails" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="event-detail-container bg-white">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <asp:HyperLink ID="lnkBack" runat="server" NavigateUrl="~/ViewEvents.aspx"
                CssClass="btn btn-outline-secondary">Back to Events</asp:HyperLink>
            <asp:HyperLink ID="lnkEdit" runat="server" CssClass="btn btn-primary">Edit Event</asp:HyperLink>
        </div>
