...
{
    public partial class User_noticeDetails : System.Web.UI.Page
    {
        ...
        private void LoadNoticeDetails(int id)
        {
            ...
            using (SqlConnection conn = new SqlConnection(connStr))
            {
                string query = @"SELECT n.Title, n.Description, n.Expiry_date, n.File_path, 
                                    n.Importance, n.Status, n.Posted_date,u.User_name
                             FROM tblNotices n JOIN tblUser u ON n.User_id=u.User_id
                ...
                if (dr.Read())
                {
                    ...
                    lblPostedBy.Text=dr["User_name"].ToString();
