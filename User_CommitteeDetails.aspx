    ...
    <div class="container">
        ...
        <asp:Panel ID="pnlEmpty" runat="server" Visible="false">
            <div class="empty-state-container">
                ...
                <h3 class="empty-state-title">No Active Committee Members</h3>
                <p class="text-muted mb-0">
                    There are currently no active committee members registered for your society.
                </p>
            </div>
        </asp:Panel>
