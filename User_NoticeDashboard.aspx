<%@ Page Title="" Language="C#" MasterPageFile="~/User.Master" AutoEventWireup="true" CodeBehind="User_NoticeDashboard.aspx.cs" Inherits="Society_management.User_NoticeDashboard" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="PageHeaderContent" runat="server">
          ...
          <a href="User_CreateNotice.aspx" class="btn-create-notice">
     ...
     <div class="col-xl-3 col-md-6 mb-4">
         <div class="dashboard-card card-1 h-100 py-2">
             <div class="card-body text-center">
                 ...
                 <a href="User_ViewAllNotice.aspx" class="card-footer-link">View All Notice <i class="fas fa-arrow-right"></i></a>
             </div>
         </div>
     </div>
     ...
     <div class="col-xl-3 col-md-6 mb-4">
         <div class="dashboard-card card-2 h-100 py-2">
             <div class="card-body text-center">
                 ...
                 <a href="User_LiveNotice.aspx" class="card-footer-link">View Live Notice <i class="fas fa-arrow-right"></i></a>
             </div>
         </div>
     </div>
     ...
     <div class="col-xl-3 col-md-6 mb-4">
         <div class="dashboard-card card-3 h-100 py-2">
             <div class="card-body text-center">
                 ...
                 <a href="User_ExpireNotice.aspx" class="card-footer-link">View Expire Notice <i class="fas fa-arrow-right"></i></a>
             </div>
         </div>
     </div>
  </div> 
